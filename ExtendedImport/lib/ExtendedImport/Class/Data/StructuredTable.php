...
class ExtendedImport_Class_Data_StructuredTable extends ExtendedImport_Class_Data {
    ...
    public function getFromCsvImport($importValue) {
        ...
        foreach($this->getRows() as $r) {
            foreach($this->getCols() as $c) {
                ...
                Logger::warning("## getFromCsvImport module ###############");
                Logger::warning($this->getRows());
                Logger::warning($this->getCols());
                Logger::warning($dataArray[$i]);
