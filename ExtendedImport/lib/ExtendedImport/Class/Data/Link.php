...
class ExtendedImport_Class_Data_Link extends ExtendedImport_Class_Data {
    ...
    public function getFromWebserviceImport($value, $relatedObject = null, $idMapper = null) {
        ...
        if (empty($value)) {
            ...
            $element = Element_Service::getElementById($value['internalType'],$id);
            if(!$element){
                if ($idMapper && $idMapper->ignoreMappingFailures()) {
                    $idMapper->recordMappingFailure($relatedObject->getId(),$value['internalType'], $value['internal']);
                    return null;
                } else {
