...
class ExtendedImport_Plugin extends Pimcore_API_Plugin_Abstract implements Pimcore_API_Plugin_Interface {
    ...
    public static function getInstallPath() {
        return PIMCORE_PLUGINS_PATH."/ExtendedImport/install";
    }
